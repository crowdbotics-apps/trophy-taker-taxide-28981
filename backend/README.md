...
## Project Structure
    ...
    ├── trophy_taker_taxide_28981  # Django project configurations
...
1. Clone this repo and `cd trophy_taker_taxide_28981`
...
2. Clone this repo and `cd trophy_taker_taxide_28981`
